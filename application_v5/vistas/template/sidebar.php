    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <?php
                /* CHAINS 20240219 - El doctor hardcodeba solo la agenda */
                ?>
                <?php if ($this->session->userdata('id_perfil') == 6 && false)  { ?>
                ...
                <?php } else { ?>
                    <?php if (isset($modulos)) {
                        ...
                        if ($modulos != 0) {
                            $padres = array("Agenda", "Carnets Templos", "Clientes", "Dietario", "Empleados", "Gestión", "Estadísticas", "Productos", "Master", "Tareas", "Notificaciones", "Evaluaciones", "Whatsapp");
                            $iconos = array("Agenda" => "calendar", "Carnets Templos" => "two-credit-cart", "Clientes" => "people", "Dietario" => "calendar-8", "Empleados" => "profile-user", "Gestión" => "document", "Estadísticas" => "chart-simple-3", "Productos" => "cube-2", "Master" => "element-11", "Tareas" => "row-horizontal", "Notificaciones" => "calendar", "Evaluaciones" => "star", "Whatsapp" => "calendar");
                            foreach ($padres as $p) {
                                $menu[$p] = "";
                            }
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <?php if (isset($modulos)) {
                                            if ($modulos != 0) {
                                                ...
                                                $no_modulos = ['Comparativa', 'Cajas Regalo', 'Carnets', 'Empleados', 'Recepcionistas', 'Pago Intercentros', 'Productos', 'Venta Carnets', 'Modificación de carnets', 'Exportar CSV', 'Duplicados CSV', 'Facturacion', 'Extra', 'Agenda Doctor'];
                                                foreach ($modulos as $key => $row) {
                                                        ...
                                                        if ($row['padre'] == $menu[$p]) { ?>
                                                            <?php if ($row['id_modulo'] == 43) { ?>
                                                                <?php if ($this->session->userdata('id_centro_usuario') == 6 || $this->session->userdata('id_centro_usuario') == 1) { ?>
                                                                    <div class="menu-item">
                                                                        <a class="menu-link"
                                                                           href="<?php echo base_url(); ?><?php echo $row['url']; ?>">
