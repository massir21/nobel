...
<p style="text-align:center"><img src="<?= $logo ?>" style=" height:2.5cm;" /></p>
	...
	<p>Que por el presente documento REQUIERO Y AUTORIZO a Dr. <?php echo strtoupper($datos_doctor[0]['nombre'])." ". strtoupper($datos_doctor[0]['apellidos']);?> licenciado en Medicina y Cirugía y/o Odontología con número de colegiado <?php echo  strtoupper($datos_doctor[0]['n_colegiado']) ?> y a su equipo a que realice en mi persona el tratamiento de <strong>pulpotomía,</strong> habiéndome explicado que es conveniente proceder, en mi situación, a recibir dicho tratamiento.</p>
...
<p style="margin-top:0pt; margin-bottom:0pt; line-height:normal; widows:0; orphans:0; font-family:Arial;">
...
<h3>
	...
	<p>Se me ha dado tiempo suficiente para leer la información precedente que describe el tratamiento de pulpotomía. Comprendo los beneficios, riesgos e inconvenientes asociados al tratamiento. <br><br>He sido suficientemente informado y he tenido la oportunidad de hacer preguntas y discutir las preocupaciones sobre el tratamiento de pulpotomía con los productos con mi dentista que me ofrece el tratamiento.  <br><br>Por la presente doy mi consentimiento para el tratamiento de pulpotomía que ha sido prescrito por mi dentista.
			</p>
