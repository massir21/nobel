...
<p style="text-align:center"><img src="<?= $logo ?>" style=" height:2.5cm;" /></p>
  ...
  <?php if ($datos_firma[0]['edad']<18){ ?>
	...
	<p>Que por el presente documento REQUIERO Y AUTORIZO a Dr. <?php echo strtoupper($datos_doctor[0]['nombre'])." ". strtoupper($datos_doctor[0]['apellidos']);?> licenciado en Medicina y Cirugía y/o Odontología con número de colegiado <?php echo  strtoupper($datos_doctor[0]['n_colegiado']) ?> y a su equipo a que realice en mi persona el tratamiento de <strong>toxina botulínica,</strong> habiéndome explicado que es conveniente proceder, en mi situación, a recibir dicho tratamiento.</p>
	
  <br>
  
  
  <p style="margin-top:0pt; margin-bottom:10pt; line-height:normal"><b>BREVE EXPLICACION DEL TRATAMIENTO:</b></p>
    ...
    <ul>
    <li>El tratamiento se realiza en una única sesión.</li>
    <li>El paciente se reincorpora inmediatamente a sus actividades habituales.</li>
    <li>El efecto aparece alrededor del 3º-4º día, y es completo a los 7-10 días.</li>
</ul>
    ...
    <p>Es asimismo un tratamiento de elección de la <strong> hiperhidrosis</strong> (sudoración excesiva), a nivel de las axilas, las palmas de las manos y las plantas de los pies; por denervación de los receptores en las glándulas sudoríparas.</p>
     ...
     <p> <b>RIESGOS INHERENTES AL PACIENTE Y A SUS CIRCUNSTANCIAS PERSONALES:</b>
  </p>
  ...
  <h3>
	...
	<p>Se me ha dado tiempo suficiente para leer la información precedente que describe el tratamiento de toxina botulínica. Comprendo los beneficios, riesgos e inconvenientes asociados al tratamiento. <br><br>He sido suficientemente informado y he tenido la oportunidad de hacer preguntas y discutir las preocupaciones sobre el tratamiento de toxina botulínica con los productos con mi dentista que me ofrece el tratamiento.  <br><br>Por la presente doy mi consentimiento para el tratamiento de toxina botulínica que ha sido prescrito por mi dentista.
			</p>
