...
<p style="text-align:center"><img src="<?= $logo ?>" style=" height:2.5cm;" /></p>
	...
	<p>Que por el presente documento REQUIERO Y AUTORIZO a Dr. <?php echo strtoupper($datos_doctor[0]['nombre'])." ". strtoupper($datos_doctor[0]['apellidos']);?> licenciado en Medicina y Cirugía y/o Odontología con número de colegiado <?php echo  strtoupper($datos_doctor[0]['n_colegiado']) ?> y a su equipo a que realice en mi persona el tratamiento de <strong>periodontal,</strong> habiéndome explicado que es conveniente proceder, en mi situación, a recibir dicho tratamiento.</p>
			...
			<p style="margin-top:0pt; margin-bottom:0pt; line-height:normal; widows:0; orphans:0">
				<span style="font-family:Arial">• Que se me ha explicado que es necesario que se me realice el tratamiento periodontal básico. </span>
			</p>
			<p style="margin-top:0pt; margin-bottom:0pt; line-height:normal; widows:0; orphans:0">
				<span style="font-family:Arial">• Que antes de iniciar dicho tratamiento he sido informado/a de que:</span>
			</p>
			<p style="margin-top:0pt; margin-bottom:0pt; line-height:normal; widows:0; orphans:0">
				<span style="font-family:Arial">- El objetivo del tratamiento periodontal es la eliminación de los factores irritativos e infecciosos que afectan a los tejidos de soporte de los dientes(encía, hueso alveolar, ligamiento periodontal,cemento radicular), alisar lassuperficies de las raíces para facilitar la adhesión de la encía al diente y reducir las bolsas periodontales, todo ello para conseguir el mantenimiento de los dientes en la boca, al detener el avance de la movilidad dental y/o la pérdida de los mismos.</span>
			</p>
			<p style="margin-top:0pt; margin-bottom:0pt; line-height:normal; widows:0; orphans:0">
			...
			<p style="margin-top:0pt; margin-bottom:0pt; line-height:normal; widows:0; orphans:0">
				<span style="font-family:Arial">- Es frecuente que después del tratamiento advierta un aumento de la sensibilidad dentaria y movilidad de los dientes, que pueden desaparecer espontáneamente o pueden requerir tratamiento posterior. Además, es común apreciar un cierto alargamiento de los dientes como consecuencia de la eliminación del tejido enfermo. </span>
			</p>
			<p style="margin-top:0pt; margin-bottom:0pt; line-height:normal; widows:0; orphans:0">
				<span style="font-family:Arial">- Todo acto odontológico lleva implícitas una serie de complicacionescomunes: pequeños daños en lostejidos blandos adyacentes e inflamación en la zona, hemorragias localizadas y molestias al cepillarse en la zona tratada, durante varios días.</span>
			</p>
			<p style="margin-top:0pt; margin-bottom:0pt; line-height:normal; widows:0; orphans:0">
				<span style="font-family:Arial">- Aunque se me han practicado los medios diagnósticos precisos, es común que durante el tratamiento ocurran hechos imprevisibles, tales como: procesos edematosos, hinchazón, dolor o laceraciones en la mucosa del labio o mejilla o en la lengua, que no dependen de la técnica empleada ni de su correcta realización. En este caso, el facultativo tomará las medidas precisas y continuará el tratamiento. </span>
			</p>
			<p style="margin-top:0pt; margin-bottom:0pt; line-height:normal; widows:0; orphans:0">
				<span style="font-family:Arial">- El tratamiento de la enfermedad periodontal no es curativo definitivamente, por lo que necesitaré un tratamiento de mantenimiento crónico a base de profilaxis (limpiezas) y ocasionales repeticiones del tratamiento periodontal básico.</span>
			</p>
			<p style="margin-top:0pt; margin-bottom:0pt; line-height:normal; widows:0; orphans:0">
				<span style="font-family:Arial">- Si no logramos alcanzar con éxito los objetivos propuestos, estará indicada la repetición de este tratamiento o pasar a la siguiente fase que sería un tratamiento quirúrgico para eliminar las bolsas, aumentar la encía o bien tratar los defectos óseos.</span>
			</p>
			<h3>
		DECLARACIONES Y FIRMAS
	</h3>
	
	<p>Se me ha dado tiempo suficiente para leer la información precedente que describe el tratamiento de periodontal. Comprendo los beneficios, riesgos e inconvenientes asociados al tratamiento. <br><br>He sido suficientemente informado y he tenido la oportunidad de hacer preguntas y discutir las preocupaciones sobre el tratamiento de periodontal con los productos con mi dentista que me ofrece el tratamiento.  <br><br>Por la presente doy mi consentimiento para el tratamiento de periodontal que ha sido prescrito por mi dentista.
			</p>
