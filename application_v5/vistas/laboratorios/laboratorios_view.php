                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-icon btn-warning"
                                       href="<?php echo base_url(); ?>laboratorios/gestion/editar/<?php echo $row['id_laboratorio'] ?>"><i
                                                class="fa-regular fa-pen-to-square"></i></a>
                                </td>
                                <td>
                                    <button class="btn btn-sm btn-icon btn-danger"
                                            onclick="Borrar(<?php echo $row['id_laboratorio'] ?>);"><i
...
<script>
    function Borrar(id_laboratorio) {
        if (confirm("¿Desea borrar el laboratorio?")) {
            document.location.href = "<?php echo base_url(); ?>laboratorios/gestion/borrar/" + id_laboratorio;
        }
        return false;
    }
