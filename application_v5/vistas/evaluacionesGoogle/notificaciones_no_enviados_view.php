        ...
        <div class="table-responsive">
            <table id="tablaCitasAvisos_dt" class="table align-middle table-striped table-row-dashed fs-6 gy-5">
                ...
                <tbody class="text-gray-700 fw-semibold">
                    ...
                    ?>
                            <tr>
                                <td><?= isset($row['fecha_pagado']) ? date('Y-m-d H:i', strtotime($row['fecha_pagado'])) : 'Fecha no disponible'; ?></td>
                                ...
                                <td><?= htmlspecialchars($row['motivo_fallido']) ?></td>
                                <td><?= isset($row['fecha_hora_envio']) ? date('Y-m-d H:i', strtotime($row['fecha_hora_envio'])) : 'Fecha no disponible'; ?></td>
                            </tr>
                    <?php
                        }
                    } ?>
