<?php /*<script>_document.location.href="/errores/error_404.html";</script>
<?php exit; */?>
			...
			<div class="d-flex flex-column flex-center text-center p-10">
                <div class="card card-flush w-lg-650px py-5">
                    <div class="card-body py-15 py-lg-20">
                        ...
                        <h1 class="text-dark fw-bolder mb-3">Oops!</h1>
                        <h1 class="text-dark fw-bolder mb-3">Página no encontrada</h1>
                        <div class="mb-3">
