            ...
            <form id="form_cita" action="<?php echo $formaction; ?>" role="form" method="post" name="form_cita" onsubmit="return ComprobarCliente();">
                <div class="row mb-5 align-items-end">
                    <div class="col-8">
                        ...
                        <select name="id_cliente" id="id_cliente" class="form-select form-select-solid" data-placeholder="Elegir ..." onchange="NotasClientes();" required data-error="Por favor, selecciona una cliente.">
                    ...
                    <div class="w-auto">
                        ...
                        <?php if (isset($cliente_elegido)) {
                            if ($cliente_elegido[0]['id_cliente'] > 0) { ?>
                                ...
                                <button type="button" class="btn btn-warning text-inverse-warning btn-icon" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" title="Copiar teléfono" onclick="copiartelefono('<?= $cliente_elegido[0]['telefono'] ?>')"><i class="fas fa-phone"></i></button>
                                <script>
                ...
                <?php if (isset($presupuestos_cliente)) { ?>
                    <div class="row mb-5 align-items-end">
                        <div class="col-12">
                            ...
                            <select name="id_presupuesto" id="id_presupuesto" class="form-select form-select-solid" data-placeholder="Elegir ..." onchange="NotasClientes();" data-error="Por favor, selecciona una opción.">
                                ...
                                <?php foreach ($presupuestos_cliente as $p => $presupuesto) {
                                    ...
                                    <option value="<?= $presupuesto['id_presupuesto'] ?>" <?= (isset($id_presupuesto) && $id_presupuesto == $presupuesto['id_presupuesto']) ? 'selected' : '' ?>>Presupuesto <?= $presupuesto['nro_presupuesto'] ?>, <?= euros($presupuesto['total_aceptado']) ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="item_presupuesto">
                        <div class="row mb-5 align-items-end">
                            <div class="col-12">
                                ...
                                <select name="id_presupuesto_item[]" id="id_presupuesto_item" class="form-select form-select-solid w-auto" data-control="select2" data-placeholder="Elegir ..." onchange="Recarga();" required data-error="Por favor, selecciona un servicio." <?= ($accion == "nuevo" || $finalizado == true) ? 'multiple' : '' ?>>
                                    <option value=""></option>
                                    <?php if (isset($presupuesto_items)) {
                ...
                <div class="row mb-5 align-items-end">
                    <div class="col-8">
                        ...
                        <select name="id_empleado" id="id_empleado" onchange="Recarga();" data-control="select2" class="form-select form-select-solid w-auto" required data-error="Por favor, selecciona un empleado.">
                ...
                <div class="row mb-5 align-items-end">
                    <div class="col-8">
                        ...
                        <select name="id_servicio" id="id_servicio" class="form-select form-select-solid w-auto" data-control="select2" data-placeholder="Elegir ..." onchange="Recarga();" data-error="Por favor, selecciona un servicio." <?= (isset($cita[0]['id_presupuesto_item'][0])) ? "" : "required" ?>>
                            <option value=""></option>
                ...
                <?php if ($accion == "editar") { ?>
                    <div class="row mb-5 align-items-end">
                        <div class="col-8">
                            ...
                            <select name="duracion_nueva" onchange="Recarga();" class="form-select form-select-solid w-auto" data-control="select2" data-placeholder="Elegir ...">
                                <option value="">No establecer</option>
                                <?php for ($t = 15; $t < 241; $t = $t + 15) { ?>
                                    <option value="<?php echo $t; ?>" <?= ($duracion_nueva == $t) ? "selected" : '' ?>><?php echo $t; ?> minutos</option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row mb-5 align-items-end">
                    <div class="col">
                        ...
                        <input type="date" id="fecha" name="fecha" onchange="Recarga();" value="<?= (isset($cita[0]['fecha_inicio_aaaammdd'])) ? $cita[0]['fecha_inicio_aaaammdd'] : '' ?>" class="form-control form-control-solid w-auto" placeholder="Fecha desde" required />
                    </div>

                    <div class="col">
                        <label for="" class="form-label">Hora</label>
                        <select name="hora" data-placeholder="Elegir hora..." data-control="select2" class="form-select form-select-solid w-auto" required>
                            <option value=""></option>
                            <?php if (isset($quelleva)) { ?>
                                <option value="<?php echo $cita[0]['hora_inicio']; ?>" selected><?php echo $cita[0]['hora_inicio']; ?></option>
                            <?php } ?>
                ...
                <div class="row mb-5 align-items-end border-bottom">
                    <div class="col-md-12 mb-5">
                        ...
                        <textarea name="observaciones" placeholder="Notas sobre el cliente" class="form-control form-control-solid" style="height: 50px;"><?= (isset($notas_cliente)) ? $notas_cliente : '' ?></textarea>
                    </div>
                    <div class="col-6 mb-5">
                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                            <input class="form-check-input w-45px h-30px" type="checkbox" id="recordatorio_sms" name="recordatorio_sms" value="1" <?= (isset($cita[0]['recordatorio_sms']) && $cita[0]['recordatorio_sms'] == 1) ? "checked" : '' ?>>
                    ...
                    <div class="col-6 mb-5">
                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                            <input class="form-check-input w-45px h-30px" type="checkbox" id="recordatorio_email" name="recordatorio_email" value="1" <?= (isset($cita[0]['recordatorio_email']) && $cita[0]['recordatorio_email'] == 1) ? "checked" : '' ?>>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <?php } else { ?>
                            ...
                            <button class="btn btn-sm btn-warning text-inverse-warning m-2" type="button" onclick="window.close();">Cerrar sin Cambios</button>
                            <button class="btn btn-sm btn-primary text-inverse-primary m-2" type="submit">Modificar</button>
                            <button class="btn btn-sm btn-danger text-inverse-denger m-2" type="button" onclick="Anular();">Anular</button>
                            <?php if (isset($cita[0]['id_presupuesto_item'])) {
                                if (
                                    isset($presupuesto_seleccionado) &&
                                    isset($servicio_presupuesto) &&
                                    (($servicio_presupuesto['coste'] <= $presupuesto_seleccionado['total_pagado'] - $presupuesto_seleccionado['total_gastado']) || $presupuesto_seleccionado['es_repeticion'] == 1)
                                ) { ?>
                                    <button class="btn btn-sm btn-success text-inverse-success m-2" type="button" onclick="Finalizar()">Finalizar</button>
                                <?php } else { ?>
                            ...
                            <?php } else { ?>
                                <button class="btn btn-sm btn-success text-inverse-success m-2" type="button" onclick="Cobrar(<?= (isset($cita[0]['id_cliente'])) ? $cita[0]['id_cliente'] : '' ?>,'<?= (isset($cita[0]['fecha_inicio_aaaammdd'])) ? $cita[0]['fecha_inicio_aaaammdd'] : '' ?>')">Cobrar</button>
                            <?php } ?>

                            <button class="btn btn-sm btn-success text-inverse-success m-2" type="button" onclick="NoVino();">No vino</button>
                        ...
                        <?php if (isset($cita[0]['no_quiere_publicidad'])) {
                            if ($cita[0]['no_quiere_publicidad'] == 0) { ?>
                                <div class="row mt-5 border-top">
                                    <div class="col-md-12 text-center">
                                        <a class="btn btn-outline btn-outine-primary" href="<?php echo base_url(); ?>clientes/proteccion_de_datos/<?= (isset($cita[0]['id_cliente'])) ? $cita[0]['id_cliente'] : '' ?>" class="btn red" target="_blank">Firmar Protección de Datos</a>
                                    </div>
                                </div>
                        <?php }
                        } ?>
                ...
                <?php if (isset($otrascitas) && is_countable($otrascitas)) {
                            ...
                            <ul class="list-grop">
                                <?php foreach ($otrascitas as $key => $row) {
                                    if ($row['id_cita'] != $citaactual) { ?>
                                        <li class="list-group-item"><?php echo $row['fecha_inicio']; ?> a las <?php echo $row['hora_inicio']; ?> -> <?php echo $row['servicio']; ?> </li>
                                <?php }
                                } ?>
                            </ul>
                    <?php }
                    ...
                    <input type="hidden" name="id_cliente_anterior" value="<?= (isset($id_cliente_anterior)) ? $id_cliente_anterior : "0" ?>">
            </form>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form name="form_nuevo_cliente" id="form_nuevo_cliente" action="<?= $actionformmodal ?>" method="post" onsubmit="return EsOk();">
                    ...
                    <input type="hidden" name="modal_id_usuario_empleado" value="<?php echo (isset($cita[0]['id_usuario_empleado'])) ? $cita[0]['id_usuario_empleado'] : ''; ?>" />
                    <input type="hidden" name="modal_hora_inicio" value="<?php echo (isset($cita[0]['hora_inicio'])) ? $cita[0]['hora_inicio'] : ''; ?>" />
                    <input type="hidden" name="modal_fecha_inicio" value="<?php echo (isset($cita[0]['fecha_inicio_aaaammdd'])) ? $cita[0]['fecha_inicio_aaaammdd'] : ''; ?>" />
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form id="form_pagoeuros" action="<?php echo base_url(); ?>Presupuestos/pagoeuros" role="form" method="post" name="form_pagoeuros">
                        <div class="modal-header">
                            <h5 id="presupuestoPagoModalLabel" class="mb-0">PRESUPUESTO Nº: <?= $presupuesto_seleccionado['nro_presupuesto'] ?></h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="row alert alert-info my-3">
                                ...
                                <div class="col-4">
                                    ...
                                    Saldo disponible: <h5><?= euros($presupuesto_seleccionado['total_pagado'] - $presupuesto_seleccionado['total_gastado']) ?></h5>
                                </div>
                                <div class="col-4">
                                    Saldo pendiente: <h5><?= euros($presupuesto_seleccionado['total_aceptado'] - $presupuesto_seleccionado['total_pagado']) ?></h5>
                            ...
                            <div class="row mb-5 align-items-end border-bottom">
                                ...
                                <input type="hidden" name="id_presupuesto" id="id_presupuesto" value="<?= $presupuesto_seleccionado['id_presupuesto'] ?>">
                            </div>
                        ...
                        <div class="modal-footer p-2 justify-content-center">
                            ...
                            <button type="button" class="btn btn-sm btn-primary text-inverse-primary" id="btn-registrar-pago" onclick="PagoPresupuesto();">Registrar pago</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        function ComprobarCliente() {
            if (document.form_cita.id_cliente.value > 0) {
                if (document.form_cita.id_empleado.value > 0) {
                    ...
                    alert("DEBES DE INDICAR UN EMPLEADO PARA LA CITA");
                    return false;
                }
            } else {
        ...
        function OtroServicioPresupuesto() {
            ...
            if (siguiente <= elementositem) {
                ...
                alert('EL PRESUPUESTO NO TIENE MÁS SERVICIOS')
            }
        }
