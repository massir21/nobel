...
<body>
    ...
    <div style="width: 100%; text-align: center;">
        ...
        <main>
            ...
            <?php if(count($desglose_presupuestos) > 0){ 
                foreach ($desglose_presupuestos as $key => $presupuesto) { ?>
                    <h3 style="text-align: center; text-transform: uppercase; padding: .5cm 1cm; background-color: #f5f8fa; ">Desglose de presupuesto <?=$key?></h3>
                    <table class="table table-striped" style="width: 100%; margin-bottom: 20px;">
                        <thead>
                            <tr>
