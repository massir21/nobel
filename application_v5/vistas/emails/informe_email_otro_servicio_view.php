...
<html lang="es">
  ...
  <body>
   <div style="padding: 30px;">      
      ...
      <br><br>
     Hemos visto que has intentado hacer una reserva online para otro servicio además del que reservaste, ¿Has tenido algún problema o hay algo en lo que podamos ayudarte? 
      <br><br>
      un saludo,<br>
      Marina Al-Assir<br>
