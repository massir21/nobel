...
<html lang="es">
  ...
  <body>
    <div style="padding: 30px;">      
      Hola <?php echo ucfirst(strtolower($cliente[0]['nombre'])); ?>,
      <br><br>
     Hemos visto que has intentado hacer una reserva online, pero al final la completaste por otro medio. ¿Has tenido algún problema o hay algo en lo que podamos ayudarte para la próxima vez? 
      <br><br>
      un saludo,<br>
      Marina Al-Assir<br>
      Directora - Templo del Masaje<br><br><br><br>
