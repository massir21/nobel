                            ...
                            foreach ($packs as $key => $row) { ?>
                                <tr>
                                    <td style="display: none;">
                                        <?php echo $row['id_pack'] ?>
                                    </td>
                                    <td>
                                        <?php echo $row['nombre_pack'] ?>
                                    </td>
                                    <td>
                                        <?php echo $row['id_tienda'] ?>
                                    </td>
                                    <td>
                                        <a class="btn btn-sm btn-icon btn-warning" href="<?php echo base_url();?>tienda/editar_pack/<?php echo $row['id_pack'] ?>"><i class="fa-regular fa-pen-to-square"></i></a>
                                    </td>
                                    <td>
                                        <button class="btn btn-sm btn-icon btn-danger" onclick="Borrar(<?php echo $row['id_pack'] ?>);"><i class="fa-solid fa-trash"></i></button>
                                    </td>
                                </tr>
                            <?php }
                        }
...
<script>
    function Borrar(id_pack) {
        if (confirm("¿Desea borrar el Pack indicado?")) {
            document.location.href = "<?php echo base_url(); ?>tienda/borrar_pack/" + id_pack;
        }
        return false;
    }
</script>