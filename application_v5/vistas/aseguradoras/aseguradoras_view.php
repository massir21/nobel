                        ...
                        <?php foreach ($registros as $key => $row): ?>
                            <tr>
                                <td style="display: none;">
                                    <?php echo $row['id_aseguradora'] ?>
                                </td>
                                <td>
                                    <?php echo $row['nombre_aseguradora'] ?>
                                </td>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-icon btn-warning"
                                       href="<?php echo base_url(); ?>aseguradoras/gestion/editar/<?php echo $row['id_aseguradora'] ?>"><i
                                                class="fa-regular fa-pen-to-square"></i></a>
                                </td>
                                <td>
                                    <button class="btn btn-sm btn-icon btn-danger"
                                            onclick="Borrar(<?php echo $row['id_aseguradora'] ?>);"><i
...
<script>
    function Borrar(id_aseguradora) {
        if (confirm("¿Desea borrar la aseguradora?")) {
            document.location.href = "<?php echo base_url(); ?>aseguradoras/gestion/borrar/" + id_aseguradora;
        }
        return false;
    }
