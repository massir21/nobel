                ...
                <div id="servicio1" class="servicio">
                    <div class="row mb-1 align-items-end sumrow">
                        ...
                        <div class="col-lg-1 col-xl-1">
                            ...
                            <input type="number" name="servicioCantidad[]" id="servicioCantidad1" class="form-control form-control-solid" value="0" step="1" min="0" max="100" required />
                        </div>
                        <div class="col-lg-1 col-xl-1">
                        ...
                        <div class="col-lg-1 col-xl-1">
                            <label for="" class="form-label">DTO €</label>
                            <input type="number" name="servicioDescuentoE[]" id="servicioDescuentoE1" class="form-control form-control-solid servicioDescuento" value="0" step=".01" min="0" required />
                        </div>
                        <div class="col-lg-1 col-xl-1">
