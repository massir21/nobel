...
<div class="card card-flush">
    <div class="card-body pt-6">
        <form name="form_presupuesto" id="form_presupuesto" action="<?php echo base_url(); ?>Presupuestos/actualizarPresupuestoMaster" method="post" onsubmit="return EsOk2();">

            <div class="row mb-5 pb-5 align-items-end border-bottom">
                <div class="col-md-3">
                    <label for="" class="form-label">Nº de presupuesto</label>
                    <input type="text" class="form-control form-control-solid" id="nro_presupuesto" name="nro_presupuesto" value="<?= $registro[0]['nro_presupuesto'] ?>" />
                </div>

                <div class="col-md-3">
                    <label for="" class="form-label">Usuario de creación:</label>
                    <select name="id_usuario" id="id_usuario" class="form-select form-select-solid" data-placeholder="Elegir ...">
                        <option value="">Selecciona un empleado</option>
                        <?php if (isset($empleados)) {
                            foreach ($empleados as $d => $empleado) { ?>
                                <option value="<?= $empleado['id_usuario'] ?>" <?= ($empleado['id_usuario'] == $registro[0]['id_usuario']) ? 'selected' : '' ?>><?= $empleado['nombre'] . ' ' . $empleado['apellidos']; ?></option>
                            <?php } ?>
                ...
                <div class="col-md-3">
                    ...
                    <input type="datetime-local" id="fecha_creacion" name="fecha_creacion" value="<?= $registro[0]['fecha_creacion'] ?>" class="form-control form-control-solid" placeholder="Fecha de creación" />
                </div>
                <div class="col-md-3">
                    <label for="" class="form-label">Revisado:</label>
                    <select class="form-select form-select-solid" id="revisado" name="revisado" required>
                        <option value="0" <?= ($registro[0]['revisado'] != 1) ? 'selected' : '' ?>>No</option>
                        <option value="1" <?= ($registro[0]['revisado'] == 1) ? 'selected' : '' ?>>Si</option>
                    </select>
                </div>
            </div>
            ...
            <div class="row mb-5 pb-5 align-items-end border-bottom">
                    ...
                    <select name="id_doctor" id="id_doctor" class="form-select form-select-solid" data-control="select2" data-placeholder="Elegir ...">
                        ...
                        <?php if (isset($doctores)) {
                            foreach ($doctores as $d => $doctor) { ?>
                                <option value="<?= $doctor['id_usuario'] ?>" <?= ($doctor['id_usuario'] == $registro[0]['id_doctor']) ? 'selected' : '' ?>><?= $doctor['nombre'] . ' ' . $doctor['apellidos'] .'('.$doctor['nombre_centro'].')' ; ?></option>
                            <?php } ?>
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select form-select-solid" id="estado" name="estado" required>
                        ...
                        <option value="Aceptado parcial" <?= ($registro[0]['estado'] == 'Aceptado parcial') ? 'selected' : '' ?>>Aceptado parcial</option>
                        <option value="Aceptado" <?= ($registro[0]['estado'] == 'Aceptado') ? 'selected' : '' ?>>Aceptado</option>
                        <option value="Rechazado" <?= ($registro[0]['estado'] == 'Rechazado') ? 'selected' : '' ?>>Rechazado</option>
                    </select>
                </div>
            </div>
                        ...
                        <div class="row mb-1 align-items-end sumrow">
                            ...
                            <div class="col-lg-2 col-xl-2">
                                ...
                                <div class="d-flex justify-content-between">
                                    <input type="text" name="servicioDientes[]" id="servicioDientes<?= $i ?>" class="form-control form-control-solid" value="<?= (isset($servicios_items[$i])) ? $value['dientes'] : '' ?>" readonly />
            ...
            <div class="row align-items-end border-bottom mb-5 pb-5">
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" id="totalcuota" name="totalcuota" class="form-control form-control-solid text-end " step=".01" value="<?= $registro[0]['totalcuota'] ?>" />
                </div>
                <div class="col-md-2">
                    <div class="col-12 mb-4">
            ...
            <div class="row align-items-end border-bottom mb-5 pb-5">
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" id="totalpresupuesto" name="totalpresupuesto" class="form-control form-control-solid text-end " step=".01" value="<?= $registro[0]['totalpresupuesto'] ?>" />
                </div>
...
$this->load->view('presupuestos/presupuestos_modal_dientes');
?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.sumrow input, #dto_euros, #dto_100, #com_cuota, #cuotas, #apertura, #anticipo_financiacion').on('input', function() {
            calcular();
        });
