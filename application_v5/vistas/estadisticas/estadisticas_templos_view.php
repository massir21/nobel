...
<div class="card card-flush">
    ...
    <div class="card-body pt-6">
        <span class="caption-subject bold uppercase">Templos canjeados por <?php echo $usuario[0]['nombre'] . " " . $usuario[0]['apellidos']; ?></span>
                        ...
                        if ($registros != 0) {
                            foreach ($registros as $key => $row) { ?>
                                <tr>
                                    ...
                                    <td style="text-align: center; vertical-align: middle">
                                        <?php echo str_replace(",0", "", (string)number_format($row['templos'], 1, ",", ".")); ?> t.
                                    </td>
                                </tr>
                    <?php }
                        }
