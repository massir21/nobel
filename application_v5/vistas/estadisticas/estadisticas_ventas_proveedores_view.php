...
<div class="card card-flush">
    ...
    <div class="card-body pt-6">
        <span class="caption-subject bold uppercase">Total de Ventas a Proveedores por <?php echo $usuario[0]['nombre'] . " " . $usuario[0]['apellidos']; ?></span>
            ...
            <table id="myTable5" class="table align-middle table-striped table-row-dashed fs-6 gy-5">
                <thead class="">
                    <tr class="text-start text-gray-600 fw-bold fs-5 text-uppercase gs-0">
                        ...
                        <th>Año</th>
                        <th>Mes</th>
                        <th>Total Ventas Proveedores</th>
                    </tr>
                </thead>
                        ...
                        if ($registros != 0) {
                            foreach ($registros as $key => $row) { ?>
                                <tr>
                                    ...
                                    <td style="text-align: center; vertical-align: middle">
                                        <?php echo number_format($row['ventas_proveedores'], 2, ',', '.'); ?> €
                                    </td>
                                </tr>
                    <?php }
                        }
