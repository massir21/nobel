...
<div class="card card-flush">
    <div class="card-header align-items-end py-5 gap-2 gap-md-5">
        ...
        <form id="form" action="<?php echo RUTA_WWW ?>/dietario/facturas/buscar" role="form" method="post" name="form">
                        ...
                        if ($facturas != 0) {
                            ...
                            foreach ($facturas as $key => $row) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-secondary btn-sm btn-text d-inline-flex align-items-center" href="<?php echo RUTA_WWW ?>/dietario/ver_factura/<?php echo $row['id_factura'] ?>" target="_blank"><?php echo $row['numero_factura'] ?></a>
                                    </td>
...
<script>
    ...
    function Buscar() {
        document.getElementById("form").action = "<?php echo RUTA_WWW ?>/dietario/facturas/buscar";
        document.getElementById("form").submit();
    }
</script>